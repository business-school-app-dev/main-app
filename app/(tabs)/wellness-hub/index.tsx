          ...
          <Box className="pb-20">
            ...
            <Box className="w-full">
              <ImageBackground
                ...
                className="w-full h-72 justify-center"
                resizeMode="cover"
              >
            ...
            <Box className="w-full px-2 pt-4 pb-2">
                ...
                {[
                  ...
                  <Box key={index} className="w-[48%] mb-4">
                    <Pressable
                      ...
                      className="bg-white rounded-lg shadow h-32 items-center justify-center space-y-2"
                    >
            ...
            <Box className="w-full px-4 pt-3 pb-6">
              <Box className="mb-4">
                <Pressable
                  ...
                  className="bg-white rounded-lg shadow flex-row items-center p-5 h-24"
                >
                ...
                <Box className="flex-row">
                  {events.map((event, idx) => (
                    <Pressable
                      ...
                      className="bg-white rounded-lg shadow w-64 mr-4 p-4"
                    >
