...
function TextButton({
  ...
  const getVariantClasses = () => {
    switch (variant) {
      case "secondary":
        return "bg-secondary-500 border border-secondary-300 data-[active=true]:border-secondary-600 data-[active=true]:bg-secondary-600";
      case "outline":
  ...
  const getTextColorClass = () => {
    switch (variant) {
      case "secondary":
        return "text-black data-[active=true]:text-gray-800";
      case "outline":
